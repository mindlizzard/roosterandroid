...
internal class MainWindow(
...
) : JFrame("RoosterPlanner 0.12.0-alpha7") {
    ...
    private fun createHeader(): JPanel = JPanel(BorderLayout()).apply {
        ...
        add(JPanel(FlowLayout(FlowLayout.LEFT, 10, 0)).apply {
            ...
            add(JLabel("v0.12.0-alpha7").apply { font = font.deriveFont(Font.BOLD, 11f) })
    ...
    private fun refreshAll() {
        ...
        title = "RoosterPlanner 0.12.0-alpha7 • ${controller.activeLocation.name} • ${monthLabel.text}"
