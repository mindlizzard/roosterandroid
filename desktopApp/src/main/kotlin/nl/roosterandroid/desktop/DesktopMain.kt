...
internal class MainWindow(
...
) : JFrame("RoosterPlanner 0.12.0-alpha3") {
    ...
    private fun createHeader(): JPanel = JPanel(BorderLayout()).apply {
        ...
        add(JPanel(FlowLayout(FlowLayout.LEFT, 10, 0)).apply {
            ...
            add(JLabel("v0.12.0-alpha3").apply { font = font.deriveFont(Font.BOLD, 11f) })
    ...
    private fun refreshAll() {
        ...
        title = "RoosterPlanner 0.12.0-alpha3 • ${controller.activeLocation.name} • ${monthLabel.text}"
