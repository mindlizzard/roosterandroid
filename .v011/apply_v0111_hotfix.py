...
if '    fun removeTemplate(' in s:
    s = replace_function(
        s,
        '    fun removeTemplate(',
        remove_template_fun,
        'removeTemplate archive'
    )
else:
    s = insert_before_class_end(
        s,
        'class DesktopController',
        remove_template_fun
    )

custom_fun = '''    fun setManualCustomAssignment(
        employeeId: String,
        date: String,
        start: String,
        end: String,
...
if 'fun setManualCustomAssignment(' not in s:
    s = insert_before_class_end(
        s,
        'class DesktopController',
        custom_fun
...
manual_fun = '''    fun setManualAssignment(
        employeeId: String,
        date: LocalDate,
        templateId: String?
    ) {
...
if '    fun setManualAssignment(' in s:
    s = replace_function(
        s,
